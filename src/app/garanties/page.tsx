          ...
          <div className="grid lg:grid-cols-2 gap-12 items-end">
            <div className="pb-10 sm:pb-20">
              ...
              <p className="text-slate-400 text-base leading-relaxed max-w-md">
                Chaque produit vendu sur ElectroShop-Tech est couvert par des garanties solides pour votre tranquillité d&rsquo;esprit.
              </p>
            </div>
            ...
            <div className="hidden lg:flex flex-col gap-4 pb-16">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-sm">
                  <p className="text-3xl font-black text-orange-400">1 an</p>
                  <p className="text-slate-400 text-xs mt-1">Garantie constructeur</p>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-sm">
                  <p className="text-3xl font-black text-orange-400">14j</p>
                  <p className="text-slate-400 text-xs mt-1">Retour sans questions</p>
                </div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-sm flex items-center gap-4">
                ...
                <div>
                  <p className="text-white font-bold text-sm">100% produits authentiques</p>
                  <p className="text-slate-400 text-xs">Sourcés auprès des fabricants officiels</p>
                </div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-sm flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-orange-500/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-white font-bold text-sm">SAV 7j/7</p>
                  <p className="text-slate-400 text-xs">Support technique inclus gratuitement</p>
                </div>
              </div>
            </div>
          </div>

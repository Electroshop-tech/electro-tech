    ...
    <section className="py-12 sm:py-16 bg-[#f5f7fb] overflow-hidden">
      ...
      <div className="text-center mt-10 px-4">
        <a
          ...
          className="inline-flex items-center gap-2 bg-white border border-slate-200 hover:border-orange-300 hover:shadow-[0_10px_24px_rgba(15,23,42,0.08)] text-slate-600 hover:text-orange-500 text-sm font-bold px-5 py-2.5 rounded-lg transition-all"
        >
